 ...
 * moments.php — 动态页
 *
 * 功能：展示自己及关注者发布的帖子（含转发），支持分页
 * 读写表：读 posts、follows、users
 * 权限：需登录
 */
session_start();
...
.fs-item:hover .fs-av-wrap { border-color: 
.fs-av {
...
.mc-name { font-size: 14px; font-weight: 700; color: 
.mc-action { font-size: 12px; color: 
.mc-time { font-size: 11px; color: 
.mc-more { color: 
.mc-more:hover { color: 
.mc-body { margin-bottom: 12px; }
.mc-text-only { font-size: 13px; color: 
.mc-with-thumb { display: flex; gap: 12px; align-items: flex-start; }
.mc-thumb { width: 120px; height: 80px; border-radius: 4px; object-fit: cover; flex-shrink: 0; border: 1px solid 
.mc-text-side { flex: 1; min-width: 0; }
.mc-title { font-size: 14px; font-weight: 700; color: 
.mc-title a { color: inherit; text-decoration: none; }
.mc-title a:hover { color: 
.mc-preview { font-size: 12px; color: 
.mc-repost-comment { font-size: 13px; color: 
.mc-actions { display: flex; gap: 20px; align-items: center; font-size: 13px; color: 
.mc-act { display: flex; align-items: center; gap: 5px; text-decoration: none; color: 
.mc-act:hover { color: 
...
.fs-av-link:hover .mc-av { border-color: 

.side-card { background: 
.side-card-head { padding: 12px 16px 10px; font-size: 16px; font-weight: 700; color: 
.trend-item { display: flex; align-items: flex-start; gap: 10px; padding: 9px 16px; border-bottom: 1px solid 
.trend-item:last-child { border-bottom: none; }
.trend-item:hover { background: 
.trend-num { font-size: 14px; font-weight: 700; min-width: 18px; margin-top: 1px; font-family: "Courier New", monospace; flex-shrink: 0; }
.trend-num.hot1 { color: 
.trend-num.hot2 { color: 
.trend-num.hot3 { color: 
.trend-num.hots { color: 
.trend-text { font-size: 13px; color: 
.trend-meta { font-size: 11px; color: 

.empty { text-align: center; padding: 60px 20px; color: 
.empty a { color: 
.pagination { display: flex; gap: 6px; justify-content: center; margin-top: 16px; flex-wrap: wrap; }
.pag-btn { padding: 5px 13px; border-radius: 4px; font-size: 12px; cursor: pointer;
           border: 1px solid 
.pag-btn:hover:not(.disabled):not(.active) { border-color: 
.pag-btn.active { background: 
