 ...
 * admin.php — 管理后台主页
 *
 * 功能：展示待审核帖子列表，支持审核通过/拒绝操作
 * 读写表：读写 posts、notifications
 * 权限：admin / owner
 */
session_start();
$skip_loader = true;
...
.ap-title{font-size:13px;font-weight:700;color:
.ap-title::before{content:'// ';}
.ap-meta{font-size:12px;color:
.ap-meta a{color:

.ap-tabs{display:flex;gap:2px;border-bottom:1px solid 
.ap-tab{padding:8px 18px;font-size:12px;font-weight:600;color:
.ap-tab:hover{color:
.ap-tab.active{color:
.ap-tab .badge{display:inline-block;background:
.ap-tab.active .badge{background:rgba(63,185,80,.15);color:

.ap-card{background:
.ap-card:hover{border-color:
.ap-card-body{padding:16px 18px;display:flex;gap:16px;align-items:flex-start;}
.ap-card-info{flex:1;min-width:0;}
.ap-card-title{font-size:14px;font-weight:600;color:
.ap-card-title a{color:inherit;text-decoration:none;} .ap-card-title a:hover{color:
.ap-card-preview{font-size:12px;color:
.ap-card-meta{display:flex;flex-wrap:wrap;align-items:center;gap:8px;font-size:11px;color:
...
.tag-pending{background:rgba(240,136,62,.15);color:
.tag-ok{background:rgba(63,185,80,.15);color:
.tag-draft{background:rgba(88,166,255,.15);color:
.tag-report-pending{background:rgba(240,136,62,.12);color:
.tag-report-handled{background:rgba(63,185,80,.1);color:
.tag-report-dismissed{background:rgba(110,118,129,.1);color:
.tag-post{background:rgba(88,166,255,.12);color:
.tag-user{background:rgba(167,139,250,.12);color:
.tag-ban-perm{background:rgba(248,81,73,.1);color:
.tag-ban-timed{background:rgba(240,136,62,.1);color:
...
.btn-view{background:
.btn-delete{background:rgba(248,81,73,.15);color:
.btn-unban{background:rgba(63,185,80,.08);color:
.btn-handled{background:rgba(63,185,80,.08);color:
.btn-dismiss{background:transparent;color:
.btn-del-post{background:rgba(248,81,73,.1);color:
.btn-ban{background:rgba(248,81,73,.08);color:
...
.btn-query{padding:9px 22px;background:
...
.stat-card .label{font-size:11px;color:
.sc-pending .num{color:

.sub-tabs{display:flex;gap:6px;margin-bottom:16px;flex-wrap:wrap;}
.stab{padding:5px 14px;border-radius:20px;font-size:12px;text-decoration:none;border:1px solid 
.stab:hover{border-color:
.stab .n{display:inline-block;background:
.stab.active .n{background:rgba(63,185,80,.2);color:
.sep-line{width:1px;height:20px;background:

.empty-state{text-align:center;padding:50px 20px;background:
...
.search-field label{display:block;font-size:11px;color:
.mid-input{width:100%;padding:9px 12px;background:
.mid-input:focus{border-color:

.user-pair{display:flex;align-items:center;gap:14px;margin-bottom:16px;flex-wrap:wrap;}
.user-card-sm{display:flex;align-items:center;gap:10px;flex:1;min-width:180px;background:
.user-card-sm img{width:36px;height:36px;border-radius:50%;object-fit:cover;border:1px solid 
.user-card-sm-name{font-size:13px;font-weight:700;color:
.user-card-sm-mid{font-size:11px;color:
.pair-sep{font-size:18px;color:
.chat-log{background:
.date-sep{display:flex;align-items:center;gap:10px;font-size:11px;color:
.date-sep::before,.date-sep::after{content:'';flex:1;height:1px;background:
.msg-row{display:flex;gap:10px;max-width:85%;} .msg-row.right{flex-direction:row-reverse;align-self:flex-end;}
.msg-avatar{width:30px;height:30px;border-radius:50%;object-fit:cover;border:1px solid 
.msg-body{display:flex;flex-direction:column;gap:3px;} .msg-row.right .msg-body{align-items:flex-end;}
.msg-meta{font-size:10px;color:
...
.msg-row.left .msg-bubble{background:
...
.pag a{padding:5px 12px;border-radius:4px;font-size:12px;text-decoration:none;border:1px solid 
.pag a:hover{border-color:

.form-group{display:flex;flex-direction:column;gap:5px;}
.form-group label{font-size:12px;color:
.form-group input[type=text],.form-group input[type=number],.form-group textarea{background:
.form-group input:focus,.form-group textarea:focus{border-color:
.form-group input[type=color]{width:46px;height:34px;padding:2px 4px;background:
.cat-row{display:flex;align-items:center;gap:14px;padding:12px 16px;border-bottom:1px solid 
.cat-row:last-child{border-bottom:none;} .cat-row:hover{background:
.cat-thumb{width:72px;height:46px;border-radius:4px;object-fit:cover;flex-shrink:0;border:1px solid 
.cat-dot{width:9px;height:9px;border-radius:50%;flex-shrink:0;}
.cat-info{flex:1;min-width:0;}
.cat-name{font-size:14px;font-weight:700;color:
.cat-meta{font-size:12px;color:
.cover-preview-box{width:220px;height:130px;border-radius:5px;background:
.cover-preview-box img{width:100%;height:100%;object-fit:cover;}
.cover-btn{display:flex;align-items:center;justify-content:center;gap:5px;background:
.cover-btn:hover{border-color:

.cmt-card{background:
.cmt-card:hover{border-color:
.cmt-body{flex:1;min-width:0;}
.cmt-content{font-size:13px;color:
.cmt-meta{font-size:11px;color:
.cmt-post-link{color:

.msg-bar{padding:9px 14px;border-radius:4px;font-size:12px;margin-bottom:14px;font-family:"Courier New",monospace;}
.msg-ok{background:rgba(63,185,80,.1);border:1px solid rgba(63,185,80,.3);color:
.msg-err{background:rgba(248,81,73,.1);border:1px solid rgba(248,81,73,.3);color:
.alert-error{background:rgba(248,81,73,.1);border:1px solid rgba(248,81,73,.3);color:
...
<div class="ap-shell">
        ...
        <div class="ap-card-body">
            ...
            <div class="ap-card-info">
                ...
                <div class="ap-card-meta">
                    ...
                    <span>目标：<?php if($is_post): ?><a href="post.php?id=<?= $r['target_id'] ?>" target="_blank" style="color:#58a6ff;">
    ...
    <div class="ap-card">
        ...
        <?php if(empty($cats)): ?><div style="padding:32px;text-align:center;color:#6e7681;font-family:'Courier New',monospace;font-size:13px;">
