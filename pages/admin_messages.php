...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .search-card h3 { margin: 0 0 14px; font-size: 12px; color: 
        ...
        .user-card img { width: 38px; height: 38px; border-radius: 50%; object-fit: cover; border: 1px solid 
        .user-card-info { display: flex; flex-direction: column; gap: 3px; }
        .user-card-name { font-size: 14px; font-weight: 700; color: 
        .user-card-mid { font-size: 11px; color: 
        ...
        .result-meta span { font-size: 12px; color: 
        .result-meta strong { color: 
        ...
        .pag-btn { padding: 5px 13px; border-radius: 4px; font-size: 12px; text-decoration: none; border: 1px solid 
        .pag-btn:hover { border-color: 
