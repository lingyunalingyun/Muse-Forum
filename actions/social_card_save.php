<?php
/**
 * social_card_save.php — 交友卡片投放、删除及管理员删除
 *
 * 功能：用户投放或删除交友卡片，管理员可强制删除任意卡片
 * POST 参数：action(save|delete|admin_delete), 卡片相关字段
 * 读写表：social_cards
 * 权限：需登录且未被封禁；admin_delete 需 admin/owner 权限
 */
session_start();
